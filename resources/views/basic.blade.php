...
<nav class="bg-default-800">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <!-- Mobile menu button -->
                @include('navigation::logout')
                <button class="inline-flex items-center justify-center p-2 text-gray-400 rounded-md hover:text-white hover:bg-default-700 focus:outline-none focus:bg-default-700 focus:text-white">
